...
```csharp
// File Storage
IFileStorage storage = new MinioFileStorage(o => o
    .ConnectionString("serviceurl=http://localhost:9000;accesskey=minioadmin;secretkey=minioadmin")
    .Bucket("my-bucket"));
...
dotnet add package Foundatio.Minio --prerelease
```
...
2. Open `Foundatio.Minio.slnx` in Visual Studio or VS Code
